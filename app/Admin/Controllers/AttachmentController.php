                  ...
                  <div class="col-12 scroll-chat mt-4" style="margin-top:5px">
                    ...
                    <div class="col-12 border-bottom">
                        <div class="my-4 row  text-head">
                               ...
                               <textarea class="col-sm-9 form-control text_control" id="textAreaMsg" rows="1" name="textAreaMsg" required style="border-radius:5px;resize:none" placeholder="Type a message"></textarea>
