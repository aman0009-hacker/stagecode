                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="contact-body">
                                    <span class="number-wise">1</span><span class="contact header ml-3">Contact
                                        Information</span>
                                    <div class="input-fields">
                                        <div class="row">
                                            <div class="col-12">
                                                <label for="name">Name</label>
                                                <span class="input">{{$data->name ?? ""}} {{$data->last_name ??
                                                    ""}}</span>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="shipping-body">
                                    <span class="number-wise">2</span><span class="contact header ml-3">Shipping
                                        Details</span>
                                    <div class="input-fields">
                                        <div class="row">
                                            <div class="col-12">
