            ...
            <div class="user-signUp-form process-pending-form d-block">
              <div class="row text-center">
                <div class="col-12">
                  ...
                  <p class="sign-up-text process-pending-text">Your Registration is Pending for<br> approval within 7 days. After <br>approval you can pay the <br>Registration fee Rupees 10,000/-</p>
                </div>
              </div>
              <div class="row">
                <div class="col-12">
                  <div class="action">
                    <a href="./login.html"  class="btn continue-btn w-100">Continue</a>
