          ...
          <div class="col-12 col-md-5 user-signUp">
            <div class="user-signUp-form user-document-form">
              <div class="row text-center">
                <div class="col-12">
                  <img src="./resources/images/login-signup/document-process.png" alt="document-process" class="img-fluid document-process" width="117" height="160">
                  ...
                  <div class="col-12 col-lg-4 col-md-6 text-lg-end text-center">
                    ...
                    <div class="mb-3">
                      ...
                      <label for="myFile" class="">
                        <div class="row text-center">
                          <div class="col-12">
                            <img src="./resources/images/login-signup/upload-icon.png" alt="upload file" id="uploaded-image" class="img-fluid upload-icon" width="25" height="18">
