                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-5 user-signUp">
                       ...
                       {{-- {{dd($txtOrderGlobalModalCompleteID)}} --}}
                            <form method="post" action="{{route('payment.process.invalid.cheque')}}">
                                @csrf
                                <input type="hidden" name="maindatas"
                                id="textmaindata"
                                value="{{$txtOrderGlobalModalCompleteID ?? " "}}">
                                <div class="row text-center">
                                    <div class="col-12">
                                        <img src="{{asset('images/login-signup/doc-success.png')}}"
                                            alt="process-pending" class="img-fluid process-pending" width="220"
                                            height="220">
                                        <h1 class="sign-up-text document-text" style="line-height: 50px;">Invalid cheque payment process</h1>
                                        <div class="input-group">
                                            <span class="input-group-text">₹</span>
                                            <input type="number" class="form-control" placeholder="Enter amount"
                                                aria-label="Amount" name="invalidChequeAmount" id="amountOrder" value="{{round($amount[0],2)}}" readonly required>
