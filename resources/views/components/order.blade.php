      ...
      <div class="col-md-12">
        ...
        <div class="row mb-3">
          <div class="col-md-12 text-center">
            ...
            {{-- <button type="button" class="btn btn-secondary order-btn" id="bookingUserStatusOrder">View Order Details</button> --}}
        ...
        @foreach ($orders as $index => $order)
          ...
          <div class="row mb-3">
            <div class="col-md-12 text-center">
              ...
              <button type="button" class="btn btn-secondary order-btn bookingUserStatusOrder" id="bookingUserStatus{{ $order->id }}" 
...
<div class="modal fade" id="alreadyPaidTotalAmount" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
