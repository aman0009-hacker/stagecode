...
<div class="container mb-5">
	<div class="row">
		<div class="col-12">
			<!-- Page title -->
			<div class="my-5">
				<h3><span id="username" style="color:#13dcff">{{$user->name}} {{$user->last_name}}</span> Profile</h3>
				<hr>
			</div>
			<!-- Form START -->
								...
								<div class="row g-3">
									...
									<div class="col-md-12">
										...
										<textarea class="form-control shipping_detail" rows="5" placeholder=""
											aria-label="" value="" name="shipaddress" readonly id="shipaddress"
											style="resize: none"
											required>{{$address->shipping_address ?? ""}}</textarea>
										@error('shipaddress')
										<div style="color:red">{{$message}}</div>
								...
								<div class="row g-3">
									...
									<div class="col-md-12">
										...
										<input type="text" class="form-control billing-detail" placeholder=""
											aria-label="" name="billname" value="{{$address->billing_name ?? ""}}"
											readonly id="billname">@error('billname')
										<div style="color:red">{{$message}}</div>
									...
									<div class="col-md-6">
										<label class="form-label">GST IN/UIN *</label>
										<input type="text" class="form-control billing-detail" placeholder=""
											aria-label="Twitter" value="{{$address->billing_gst_number ?? ""}}" readonly
											id="billgstnumber" name="billgstnumber">
										@error('billgstnumber')
										<div style="color:red">{{$message}}</div>
									...
									<div class="col-md-6">
										...
										<input type="number" class="form-control billing-detail" placeholder=""
											...
											value="{{$address->billing_gst_statecode ?? ""}}" readonly id="billgstcode">
										@error('billgstcode')
										<div style="color:red">{{$message}}</div>
									...
									<div class="col-md-6">
										<label class="form-label">State *</label>
										<input type="text" class="form-control billing-detail" placeholder=""
											aria-label="ITR" name="billstate" value="{{$address->billing_state ?? ""}}"
											readonly id="billstate">
										@error('billstate')
										<div style="color:red">{{$message}}</div>
									...
									<div class="col-md-6">
										<label class="form-label">City *</label>
										<input type="text" class="form-control billing-detail" placeholder=""
											aria-label="Aadhar" value="{{$address->billing_city ?? ""}}" name="billcity"
											readonly id="billcity">
										@error('billcity')
										<div style="color:red">{{$message}}</div>
									...
									<div class="col-md-12">
										...
										<textarea class="form-control billing-detail" rows="5" placeholder=""
											aria-label="" value="" name="billaddress" readonly id="billaddress"
											style="resize: none">{{$address->billing_address ?? ""}}</textarea>
										@error('billaddress')
										<div style="color:red">{{$message}}</div>
