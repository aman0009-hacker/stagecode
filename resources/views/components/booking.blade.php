                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12 text-center">
                                <a href="" class="btn btn-secondary order-btn"  data-bs-toggle="modal" data-bs-target="#confirmationModal">View Order Details</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-footer mb-4">
                <a href="" class="btn btn-secondary continue-btn" data-bs-target="#makepaymentnModal" data-bs-toggle="modal">ok</a>
