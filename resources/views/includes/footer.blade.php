    ...
    <div class="container">
      <div class="row py-md-5">
        <div class="col-md-3 col-lg-3 col-xl-3">
          <div class="py-5">
            <img src="{{asset('images/home-page/logo-psiec.png')}}" alt="footer-logo" class="img-fluid" />
          </div>
        </div>
            ...
            <div class="col-md-4">
              ...
              <ul class="list-unstyled-end mt-5">
                <li>
                  <a href="#" class="text-decoration-none">
                    <p>
                      <span><b>Address:</b>: 18-Himalya Marg, Udyog Bhawan,
                        Sector 17A, Chandigarh - 160017</span>
                    </p>
                  </a>
                </li>
                <li>
                  <a href="#" class="text-decoration-none">
                    <span>
                      <img src="{{asset('images/home-page/call.png')}}" class="img-fluid" alt="no-image" />
                    </span>
                ...
                <li>
                  <a href="#" class="text-decoration-none">
                    <span>
                      <img src="{{asset('images/home-page/Vector.png')}}" class="img-fluid" alt="no-image" />
                    </span>
                    <span>
                      <b>E-mail</b> : eauctions.psiec@gmail.com</span>
                  </a>
                </li>
                <li>
                  <a href="#" class="text-decoration-none">
                    <span>
                      <img src="{{asset('images/home-page/whatsapp.png')}}" class="img-fluid" alt="no-image" />
                    </span>
                    <span> <b>Whatsapp</b>: +86-13029879858 </span>
                  </a>
                </li>
              </ul>
              <div class="social-icons my-md-4">
                <ul>
                  <li>
                    <a href="">
                      <img src="{{asset('images/home-page/facebook.png')}}" class="img-fluid" />
                    </a>
                  </li>
                  <li>
                    <a href="">
                      <img src="{{asset('images/home-page/twitter.png')}}" class="img-fluid" />
                    </a>
                  </li>
                  <li>
                    <a href="">
                      <img src="{{asset('images/home-page/instagram.png')}}" class="img-fluid" />
                    </a>
                  </li>
                </ul>
              </div>
