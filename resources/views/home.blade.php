          ...
          <div class="row h-100 align-items-center">
            <div class="col-md-6">
              <div class="about-content">
                ...
                <a href="#" class="btn btn-secondary read-more mt-md-5 mt-2"
                  >Read More
                </a>
              </div>
            </div>
            ...
            <div class="col-md-4 mt-5 mt-md-0">
              <div>
                <img
                  src="{{('images/home-page/about-Psiec.webp')}}"
                  class="img-fluid"
                  alt="no-image"
                />
              </div>
          ...
          <div class="row h-100 align-items-center">
            <div class="col-lg-9 col-xl-9 col-md-6">
              <div class="vision-section">
                ...
                <a href="#" class="btn btn-secondary read-more mt-md-5"
                  >Read More
                </a>
              </div>
            </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-3 col-xl-3 col-md-6 d-flex justify-content-center">
                  <div class="white-box">
                    ...
                    <div class="circle">
                      <img
                        src="{{asset('images/home-page/import.png')}}"
                        class="img-fluid"
                        alt="no-image"
                      />
                    </div>
                ...
                <div class="col-lg-3 col-xl-3 col-md-6 d-flex justify-content-center">
                  <div class="white-box">
                    ...
                    <div class="circle">
                      <img
                        src="{{asset('images/home-page/category.png')}}"
                        class="img-fluid"
                        alt="no-image"
                      />
                    </div>
                ...
                <div class="col-lg-3 col-xl-3 col-md-6 d-flex justify-content-center">
                  <div class="white-box">
                    ...
                    <div class="circle">
                      <img
                        src="{{asset('images/home-page/register-user.png')}}"
                        class="img-fluid"
                        alt="no-image"
                      />
                    </div>
                ...
                <div class="col-lg-3 col-xl-3 col-md-6 d-flex justify-content-center">
                  <div class="white-box">
                    ...
                    <div class="circle">
                      <img
                        src="{{asset('images/home-page/industries.png')}}"
                        class="img-fluid"
                        alt="no-image"
                      />
                    </div>
                ...
                <table class="table" style="width: 100%">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>3 mm</td>
                      <td>
                        <a href="" class="btn btn-secondary book-now"
                          >Book Now</a
                        >
                      </td>
                    </tr>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="white-box-two">
                    <div class="content">
                      <h4>Mail</h4>
                      <a href="mailto:eauctions.psiec@gmail.com"
                        >eauctions.psiec@gmail.com</a
                      >
                    </div>
                  </div>
                </div>
